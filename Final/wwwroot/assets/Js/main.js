...
// const progressContainer = document.querySelector('.music-range');
// const title = document.querySelector('#title');
// const cover = document.querySelector('#cover')
// const duration = document.querySelector('.track-timer')
...
//   e.target.nextElementSibling.children[0].innerText = min + ' : '
//   e.target.nextElementSibling.children[0].innerText = sec
