...
namespace Final.Migrations
{
    ...
    [Migration("20220418112909_AppUserTableEditted")]
    partial class AppUserTableEditted
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Final.Models.AlbumTrack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Final.Models.TourOrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Final.Models.WebSiteVisitor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Final.Models.Album", b =>
                {
                    b.HasOne("Final.Models.Genre", "Genres")
                        .WithMany("Albums")
            ...
            modelBuilder.Entity("Final.Models.BlogTags", b =>
                {
                    b.HasOne("Final.Models.Blog", "Book")
                        .WithMany("BlogTags")
                        .HasForeignKey("BlogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Final.Models.Tags", "Tag")
                        .WithMany()
                        .HasForeignKey("TagsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
