...
namespace Final.Areas.manage.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        {
            var orders = _context.Orders.Include(x => x.OrderItems).ThenInclude(x => x.Tours).AsQueryable();
        ...
        {
            Order order = _context.Orders.Include(x => x.OrderItems).ThenInclude(x => x.Tours).FirstOrDefault(x => x.Id == id);
